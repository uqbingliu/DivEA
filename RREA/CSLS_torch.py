...
class Evaluator():
    ...
    def evaluate_csls(self, embed1: np.ndarray, embed2: np.ndarray, eval_alignment, top_k=(1, 5, 10, 50), target_candidates=None):
        t1 = time.time()
    ...
    def evaluate_cosine(self, embed1: np.ndarray, embed2: np.ndarray, eval_alignment, top_k=(1, 5, 10, 50), target_candidates=None):
